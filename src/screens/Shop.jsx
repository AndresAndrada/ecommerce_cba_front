...
export default function Shop() {
    ...
    // const { getAllProducts, getAllCategories, loading } = useGetProducts()
    ...
    //     getAllProducts(
    //         CurrentProductsPage,
    //         queryPath[ConsumerProducts],
    //         debounceSearch,
    //         SelectedTab
    //     )
    // }, [CurrentProductsPage, ConsumerProducts, debounceSearch, SelectedTab])
                    ...
                    {Products.length === 0 ? (
                        <div className="h-[300px] w-full flex justify-center items-center">
                            <div className="flex flex-col items-center justify-center">
                                <FaceFrownIcon className="h-16 text-primary" />
                                <p className="text-xl">No se encontrar productos</p>
                            </div>
                        </div>
                    ) : (
                        <div className="mx-4">
